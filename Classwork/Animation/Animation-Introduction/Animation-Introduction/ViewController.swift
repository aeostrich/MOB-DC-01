...
//        self.view.layer.backgroundColor = UIColor(white: 0.9, alpha: 1.0).CGColor
        self.view.layer.backgroundColor = UIColor(red: 0.15, green: 0.80, blue: 0.70, alpha: 1.0).CGColor
...
//        self.view.layer.sublayers = nil
        ...
        // Loop through all layers and only delete those that match some criteria
    ...
    @IBAction func createGradient(sender: AnyObject) {
        ...
        */
        ...
        gradient.colors = [UIColor(red: 0.20, green: 0.80, blue: 0.70, alpha: 1.0).CGColor, UIColor(red: 0.20, green: 0.20, blue: 0.80, alpha: 1.0).CGColor, UIColor(red: 0.80, green: 0.20, blue: 0.20, alpha: 1.0).CGColor]
        gradient.startPoint = CGPointMake(0, 0)
        gradient.endPoint = CGPointMake(1, 1)
        gradient.locations = [0.4, 0.7, 1.0]
